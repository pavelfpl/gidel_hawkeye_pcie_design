// gidel_hawkeye_pcie_altera_mm_interconnect_181_7hr3cja.v
...
`timescale 1 ps / 1 ps
module gidel_hawkeye_pcie_altera_mm_interconnect_181_7hr3cja (
		...
		input  wire [5:0]   pcie_a10_hip_0_rxm_bar4_burstcount,                  //                                              .burstcount
		input  wire [15:0]  pcie_a10_hip_0_rxm_bar4_byteenable,                  //                                              .byteenable
		input  wire         pcie_a10_hip_0_rxm_bar4_read,                        //                                              .read
		output wire [127:0] pcie_a10_hip_0_rxm_bar4_readdata,                    //                                              .readdata
		output wire         pcie_a10_hip_0_rxm_bar4_readdatavalid,               //                                              .readdatavalid
		input  wire         pcie_a10_hip_0_rxm_bar4_write,                       //                                              .write
		input  wire [127:0] pcie_a10_hip_0_rxm_bar4_writedata,                   //                                              .writedata
	...
	wire  [127:0] pcie_a10_hip_0_rxm_bar4_translator_avalon_universal_master_0_readdata;      // pcie_a10_hip_0_rxm_bar4_agent:av_readdata -> pcie_a10_hip_0_rxm_bar4_translator:uav_readdata
	...
	wire   [15:0] pcie_a10_hip_0_rxm_bar4_translator_avalon_universal_master_0_byteenable;    // pcie_a10_hip_0_rxm_bar4_translator:uav_byteenable -> pcie_a10_hip_0_rxm_bar4_agent:av_byteenable
	...
	wire  [127:0] pcie_a10_hip_0_rxm_bar4_translator_avalon_universal_master_0_writedata;     // pcie_a10_hip_0_rxm_bar4_translator:uav_writedata -> pcie_a10_hip_0_rxm_bar4_agent:av_writedata
	wire    [9:0] pcie_a10_hip_0_rxm_bar4_translator_avalon_universal_master_0_burstcount;    // pcie_a10_hip_0_rxm_bar4_translator:uav_burstcount -> pcie_a10_hip_0_rxm_bar4_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                          // rsp_mux:src_valid -> pcie_a10_hip_0_rxm_bar4_agent:rp_valid
	wire  [248:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> pcie_a10_hip_0_rxm_bar4_agent:rp_data
	wire          rsp_mux_src_ready;                                                          // pcie_a10_hip_0_rxm_bar4_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> pcie_a10_hip_0_rxm_bar4_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                  // rsp_mux:src_startofpacket -> pcie_a10_hip_0_rxm_bar4_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                    // rsp_mux:src_endofpacket -> pcie_a10_hip_0_rxm_bar4_agent:rp_endofpacket
	...
	wire  [249:0] onchip_memory2_0_s1_agent_rf_source_data;                                   // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [249:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                                // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire          pcie_a10_hip_0_rxm_bar4_agent_cp_valid;                                     // pcie_a10_hip_0_rxm_bar4_agent:cp_valid -> router:sink_valid
	wire  [248:0] pcie_a10_hip_0_rxm_bar4_agent_cp_data;                                      // pcie_a10_hip_0_rxm_bar4_agent:cp_data -> router:sink_data
	wire          pcie_a10_hip_0_rxm_bar4_agent_cp_ready;                                     // router:sink_ready -> pcie_a10_hip_0_rxm_bar4_agent:cp_ready
	wire          pcie_a10_hip_0_rxm_bar4_agent_cp_startofpacket;                             // pcie_a10_hip_0_rxm_bar4_agent:cp_startofpacket -> router:sink_startofpacket
	wire          pcie_a10_hip_0_rxm_bar4_agent_cp_endofpacket;                               // pcie_a10_hip_0_rxm_bar4_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [248:0] onchip_memory2_0_s1_agent_rp_data;                                          // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [248:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [248:0] onchip_memory2_0_s1_burst_adapter_source0_data;                             // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [129:0] onchip_memory2_0_s1_agent_rdata_fifo_src_data;                              // onchip_memory2_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	...
	altera_merlin_master_translator #(
		...
		.av_burstcount          (pcie_a10_hip_0_rxm_bar4_burstcount),                                         //                          .burstcount
	...
	gidel_hawkeye_pcie_altera_merlin_router_181_xozklya router (
	...
	gidel_hawkeye_pcie_altera_merlin_router_181_t6gakvq router_001 (
	...
	gidel_hawkeye_pcie_altera_merlin_demultiplexer_181_hwavjra cmd_demux (
		.clk                (pcie_a10_hip_0_coreclkout_hip_clk),                   //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_merlin_multiplexer_181_w2a5qby cmd_mux (
		.clk                 (pcie_a10_hip_0_coreclkout_hip_clk),                   //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_merlin_demultiplexer_181_hwavjra rsp_demux (
		.clk                (pcie_a10_hip_0_coreclkout_hip_clk),                   //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_merlin_multiplexer_181_kt7sjfa rsp_mux (
		.clk                 (pcie_a10_hip_0_coreclkout_hip_clk),                   //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_avalon_st_adapter_181_4htxdaa #(
		.inBitsPerSymbol (130),
		.inUsePackets    (0),
		.inDataWidth     (130),
		.inChannelWidth  (0),
