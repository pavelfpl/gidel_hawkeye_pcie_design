// gidel_hawkeye_pcie_altera_mm_interconnect_181_f72zoky.v
...
`timescale 1 ps / 1 ps
module gidel_hawkeye_pcie_altera_mm_interconnect_181_f72zoky (
		...
		input  wire [18:0]  mm_bridge_1_m0_address,                        //                          mm_bridge_1_m0.address
	...
	wire   [18:0] mm_bridge_1_m0_translator_avalon_universal_master_0_address;       // mm_bridge_1_m0_translator:uav_address -> mm_bridge_1_m0_agent:av_address
	...
	wire   [91:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_1_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                 // mm_bridge_1_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                               // rsp_mux:src_channel -> mm_bridge_1_m0_agent:rp_channel
	...
	wire   [18:0] onchip_memory2_0_s2_agent_m0_address;                              // onchip_memory2_0_s2_agent:m0_address -> onchip_memory2_0_s2_translator:uav_address
	...
	wire  [344:0] onchip_memory2_0_s2_agent_rf_source_data;                          // onchip_memory2_0_s2_agent:rf_source_data -> onchip_memory2_0_s2_agent_rsp_fifo:in_data
	...
	wire  [344:0] onchip_memory2_0_s2_agent_rsp_fifo_out_data;                       // onchip_memory2_0_s2_agent_rsp_fifo:out_data -> onchip_memory2_0_s2_agent:rf_sink_data
	...
	wire   [91:0] mm_bridge_1_m0_agent_cp_data;                                      // mm_bridge_1_m0_agent:cp_data -> router:sink_data
	...
	wire  [343:0] onchip_memory2_0_s2_agent_rp_data;                                 // onchip_memory2_0_s2_agent:rp_data -> router_001:sink_data
	...
	wire   [91:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> onchip_memory2_0_s2_cmd_width_adapter:in_data
	...
	wire  [343:0] onchip_memory2_0_s2_cmd_width_adapter_src_data;                    // onchip_memory2_0_s2_cmd_width_adapter:out_data -> onchip_memory2_0_s2_agent:cp_data
	...
	wire    [0:0] onchip_memory2_0_s2_cmd_width_adapter_src_channel;                 // onchip_memory2_0_s2_cmd_width_adapter:out_channel -> onchip_memory2_0_s2_agent:cp_channel
	...
	wire  [343:0] router_001_src_data;                                               // router_001:src_data -> onchip_memory2_0_s2_rsp_width_adapter:in_data
	...
	wire   [91:0] onchip_memory2_0_s2_rsp_width_adapter_src_data;                    // onchip_memory2_0_s2_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	altera_merlin_slave_agent #(
		.PKT_ORI_BURST_SIZE_H      (343),
		.PKT_ORI_BURST_SIZE_L      (341),
		.PKT_RESPONSE_STATUS_H     (340),
		.PKT_RESPONSE_STATUS_L     (339),
		.PKT_BURST_SIZE_H          (322),
		.PKT_BURST_SIZE_L          (320),
		.PKT_TRANS_LOCK            (311),
		.PKT_BEGIN_BURST           (327),
		.PKT_PROTECTION_H          (334),
		.PKT_PROTECTION_L          (332),
		.PKT_BURSTWRAP_H           (319),
		.PKT_BURSTWRAP_L           (319),
		.PKT_BYTE_CNT_H            (318),
		.PKT_BYTE_CNT_L            (313),
	...
	gidel_hawkeye_pcie_altera_merlin_router_181_rimmbqy router (
	...
	gidel_hawkeye_pcie_altera_merlin_router_181_v2xnjyq router_001 (
	...
	gidel_hawkeye_pcie_altera_merlin_demultiplexer_181_fkf75ui cmd_demux (
		.clk                (pcie_a10_hip_0_coreclkout_hip_clk),             //       clk.clk
		.reset              (mm_bridge_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_merlin_multiplexer_181_ambf7wa cmd_mux (
		.clk                 (pcie_a10_hip_0_coreclkout_hip_clk),             //       clk.clk
		.reset               (mm_bridge_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_merlin_demultiplexer_181_fkf75ui rsp_demux (
		.clk                (pcie_a10_hip_0_coreclkout_hip_clk),                       //       clk.clk
		.reset              (mm_bridge_1_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	gidel_hawkeye_pcie_altera_merlin_multiplexer_181_byxvdyi rsp_mux (
		.clk                 (pcie_a10_hip_0_coreclkout_hip_clk),             //       clk.clk
		.reset               (mm_bridge_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.OUT_PKT_BURST_SIZE_H          (322),
		.OUT_PKT_BURST_SIZE_L          (320),
		.OUT_PKT_RESPONSE_STATUS_H     (340),
		.OUT_PKT_RESPONSE_STATUS_L     (339),
		.OUT_PKT_TRANS_EXCLUSIVE       (312),
		.OUT_PKT_BURST_TYPE_H          (324),
		.OUT_PKT_BURST_TYPE_L          (323),
		.OUT_PKT_ORI_BURST_SIZE_L      (341),
		.OUT_PKT_ORI_BURST_SIZE_H      (343),
		.OUT_ST_DATA_W                 (344),
		.ST_CHANNEL_W                  (1),
		.OPTIMIZE_FOR_RSP              (0),
		.RESPONSE_PATH                 (0),
	...
	altera_merlin_width_adapter #(
		...
		.IN_PKT_BURSTWRAP_H            (319),
		.IN_PKT_BURSTWRAP_L            (319),
		.IN_PKT_BURST_SIZE_H           (322),
		.IN_PKT_BURST_SIZE_L           (320),
		.IN_PKT_RESPONSE_STATUS_H      (340),
		.IN_PKT_RESPONSE_STATUS_L      (339),
		.IN_PKT_TRANS_EXCLUSIVE        (312),
		.IN_PKT_BURST_TYPE_H           (324),
		.IN_PKT_BURST_TYPE_L           (323),
		.IN_PKT_ORI_BURST_SIZE_L       (341),
		.IN_PKT_ORI_BURST_SIZE_H       (343),
		.IN_ST_DATA_W                  (344),
		.OUT_PKT_ADDR_H                (54),
		.OUT_PKT_ADDR_L                (36),
		.OUT_PKT_DATA_H                (31),
