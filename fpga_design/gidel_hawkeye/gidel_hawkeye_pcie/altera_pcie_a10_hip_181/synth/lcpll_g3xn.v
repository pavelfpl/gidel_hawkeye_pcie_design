...
module lcpll_g3xn #(
		...
		parameter hssi_pma_lc_refclk_select_mux_silicon_rev                        = "20nm3",
		...
		parameter hssi_refclk_divider_silicon_rev                                  = "20nm3",
		parameter atx_pll_silicon_rev                                              = "20nm3",
	...
	generate
		...
		if (hssi_pma_lc_refclk_select_mux_silicon_rev != "20nm3")
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (hssi_refclk_divider_silicon_rev != "20nm3")
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
	...
	gidel_hawkeye_pcie_altera_xcvr_atx_pll_a10_181_shiouiy #(
