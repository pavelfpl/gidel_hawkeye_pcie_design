...
library IEEE;
library gidel_hawkeye_pcie_altera_xcvr_atx_pll_a10_181;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;
use gidel_hawkeye_pcie_altera_xcvr_atx_pll_a10_181.lcpll_g3xn_pkg.all;
...
entity lcpll_g3xn is
	generic (
		...
		hssi_pma_lc_refclk_select_mux_silicon_rev                        : string  := "20nm3";
		...
		hssi_refclk_divider_silicon_rev                                  : string  := "20nm3";
		atx_pll_silicon_rev                                              : string  := "20nm3";
...
begin
	...
	hssi_pma_lc_refclk_select_mux_silicon_rev_check : if hssi_pma_lc_refclk_select_mux_silicon_rev /= "20nm3" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	hssi_refclk_divider_silicon_rev_check : if hssi_refclk_divider_silicon_rev /= "20nm3" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	atx_pll_silicon_rev_check : if atx_pll_silicon_rev /= "20nm3" generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	lcpll_g3xn : component gidel_hawkeye_pcie_altera_xcvr_atx_pll_a10_181.lcpll_g3xn_pkg.gidel_hawkeye_pcie_altera_xcvr_atx_pll_a10_181_shiouiy
		generic map (
			...
			hssi_pma_lc_refclk_select_mux_silicon_rev                        => "20nm3",
			...
			hssi_refclk_divider_silicon_rev                                  => "20nm3",
			atx_pll_silicon_rev                                              => "20nm3",
